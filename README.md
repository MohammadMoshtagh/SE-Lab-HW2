...
<td>
<p>
برای اضافه کردن قابلیت ارسال پیام با تلگرام ناچاریم بقیه‌ی سرویس‌های دیگر ارسال پیام را نیز تغییر دهیم و تابع مربوط به ارسال پیام با تلگرام را با بدنه خالی به آن‌ها اضافه کنیم.
</p>
</td>
</tr>
...
<td>
<p>
از آنجایی که تعریف نوع متغیر مسیج سرویس از واسط سطح بالا (main) صورت گرفته است، در آن بخش DIP محقق شده است.
</p>
</td>
</tr>
<tr>
...
در پیاده‌سازی جدید به راحتی می‌توان سرویس‌های مسیجینگ مختلف اضافه کرد بدون آنکه نیازی به تغییر در کد سرویس‌های مسیجینگ دیگر باشد و در نتیجه وابستگی کدها کم شود. (اصل ۲)
دیگر سرویس‌های مختلف نیازی به پیاده‌سازی توابع با بدنه‌ی خالی ندارند. (اصل ۴)
دیگر کلاس مسیجینگ سرویس نیازی به پیاده‌سازی تابع برای انواع روش‌های مسیجینگ ندارد (اصل ۳)
